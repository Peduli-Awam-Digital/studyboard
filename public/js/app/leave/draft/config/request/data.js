// Datatable
var $dataTableRows = $("#datatableLeave").DataTable({
    bLengthChange: false,
    buttons: [
      'copy',
      'excel',
...
$('#datatableLeave tbody').on('click', 'tr', function () {
...
function controlCheckAll() {
    ...
    var allChecked = true;
    $('#datatableLeave tbody tr .custom-checkbox input').each(function () {
...
function unCheckAllRows() {
    $('#datatableLeave tbody tr').removeClass('selected');
    $('#datatableLeave tbody tr .custom-checkbox input').prop("checked", false).trigger("change");
}

function checkAllRows() {
    $('#datatableLeave tbody tr').addClass('selected');
    $('#datatableLeave tbody tr .custom-checkbox input').prop("checked", true).trigger("change");
}
