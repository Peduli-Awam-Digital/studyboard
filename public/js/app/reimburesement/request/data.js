// Datatable
var $dataTableRows = $("#datatableReimburesement").DataTable({
    bLengthChange: false,
    buttons: [
      'copy',
      'excel',
...
$('#datatableReimburesement tbody').on('click', 'tr', function () {
...
function controlCheckAll() {
    ...
    var allChecked = true;
    $('#datatableReimburesement tbody tr .custom-checkbox input').each(function () {
...
function unCheckAllRows() {
    $('#datatableReimburesement tbody tr').removeClass('selected');
    $('#datatableReimburesement tbody tr .custom-checkbox input').prop("checked", false).trigger("change");
}

function checkAllRows() {
    $('#datatableReimburesement tbody tr').addClass('selected');
    $('#datatableReimburesement tbody tr .custom-checkbox input').prop("checked", true).trigger("change");
}
...
$( ".btn-act-create" ).click(function() {
    var link = '/reimburesement/request/create';
    zCreate(link);
});